...
class MD3Theme
{
	...
	/** Short 1: 50 ms */
	public static inline var DUR_S1:Float = 0.050;

	/** Short 2: 100 ms */
	public static inline var DUR_S2:Float = 0.100;

	/** Short 3: 150 ms */
	public static inline var DUR_S3:Float = 0.150;

	/** Short 4: 200 ms */
	public static inline var DUR_S4:Float = 0.200;

	/** Medium 1: 250 ms */
	public static inline var DUR_M1:Float = 0.250;

	/** Medium 2: 300 ms */
	public static inline var DUR_M2:Float = 0.300;

	/** Medium 3: 350 ms */
	public static inline var DUR_M3:Float = 0.350;

	/** Medium 4: 400 ms */
	public static inline var DUR_M4:Float = 0.400;

	/** Long 1: 450 ms */
	public static inline var DUR_L1:Float = 0.450;

	/** Long 2: 500 ms */
	public static inline var DUR_L2:Float = 0.500;
	...
	{
		return hovered ? mix(surfaceVariant, primary, isDark ? 0.10 : 0.06) : surfaceVariant;
	}
	...
	public static function colorFromHSL(h:Float, s:Float, l:Float):FlxColor
	{
		...
		return FlxColor.fromRGB(Std.int((r + m) * 255), Std.int((g + m) * 255), Std.int((b + m) * 255));
	}
}
