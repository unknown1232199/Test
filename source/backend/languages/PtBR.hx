...
class PtBR
{
	...
	public static var translations:Map<String, String> = [
		...
		"Se marcado, permite que a GPU seja usada para armazenar texturas, reduzindo uso da memória RAM.\nNão ligue isso se sua Placa de Vídeo é ruim.",
		...
		"Se ativado, impede o jogo de \"travar\" e \"ficar mais fluido\" quando seus FPS atuais estão abaixo do limite de taxa de atualização.",
		// Visuals Settings
		...
		"Mostra informações do chart como velocidade de scroll, BPM, vida; também os steps, beats, etc.\nO último estará disponível se você estiver no modo Chart.",
		...
		"setting_vsync" => "VSync",
		"description_vsync" =>
		"Se ativado, ativa o VSync em corrigindo o screen tearing ao custo de limitar os FPS ao refresh rate do seu monitor.\n(Você precisa reiniciar o jogo para aplicar)",
		...
		"Desmarque esta caixa para evitar leaks acidentais do seu Mod,\nIsso irá esconder o que você está jogando para os outros.",
		...
		"Se marcado, notas longas não poderão ser acertadas se a principal não for acertada,\nalém de contar como um único erro.",
