...
class EsLA
{
	...
	public static var translations:Map<String, String> = [
		...
		"new_personal_best" => "Puntaje: {1}\nPrecision: {2}% ({3})",
		"freeplay_tip" =>
		"Toca ESPACIO para escuchar la canción / Tocar CTRL abre menú de cambios de juego / Toca REINICIAR para restablecer puntuación y precisión.",
		"new_freeplay_tip" => "Toca {1} para previsualizar / Toca {2} para cambios de gameplay / Toca {3} para reiniciar puntaje y precision.",
		...
		"Si está marcado, esto evita que el juego se vuelva \"lento\" y \"suave\" cuando los FPS actuales son más bajos que el límite de FPS.",
		// Visuals Settings
		...
		"Muestra información de chart como velocidad de desplazamiento, BPM, salud; tambien los steps, beats, etc.\nEstos ultimos estaran disponibles si estas en modo Chart.",
		...
		"setting_vsync" => "VSync",
		"description_vsync" =>
		"Si está marcado, Habilita VSync corrigiendo cualquier desgarro de pantalla a costa de limitar los FPS a la tasa de refresco de la pantalla.\n(Debe reiniciar el juego para que tenga efecto)",
		...
		"Si no está marcado, las calificaciones y el combo no se almacenará, lo que ahorrará en la memoria del sistema y facilitará su lectura.",
		...
		"Si está marcado, las notas retenidas no se pueden presionar si fallas y cuentan como un solo acierto/fallo.\nSi se desmarca, esto significa que prefieres el antiguo sistema de entrada",
		...
		"description_optimize_hold_rendering" =>
		"Optimiza el renderizado de las notas largas para mejorar el rendimiento.\nPuede afectar las visuales de las notas largas.",
		"setting_z-axis_scale" => "Escala del eje Z:",
		"description_z-axis_scale" =>
		"Ajusta los valores del eje Z para controlar la profundidad percibida.\nLos valores más altos aumentan la profundidad, los valores más bajos la reducen.",
		...
		"description_prevent_scaled_hold_ends" =>
		"Si está marcado, el tamaño del fin de las notas largas no se verá afectado por la escala de las notas largas.\nADVERTENCIA: Puede afectar el rendimiento si hay muchas notas largas en pantalla.",
		"setting_column_specific_modifiers" => "Modificadores específicos de columna",
		"description_column_specific_modifiers" =>
		"Si está marcado, permite aplicar modificadores específicos a columnas individuales.\nDesabilitarlo puede mejorar el rendimiento reduciendo calculos.",
		...
		"description_allow_phone_screensaver" =>
		"Si está marcado, el salvapantallas del teléfono se activará normalmente.\n(El tiempo depende de la configuración del sistema)",
		"setting_wide_screen_mode" => "Modo Pantalla Ancha",
		"description_wide_screen_mode" =>
		"Si está marcado, ajusta la relación de aspecto del juego para adaptarse a pantallas más anchas.\nPuede causar errores y crashes en algunos dispositivos.",
		...
		"description_dynamic_controls_color" =>
		"Si está marcado, los colores de los controles cambiarán dinámicamente según los colores de las notas de tus ajustes.",
		// Loading Screen
