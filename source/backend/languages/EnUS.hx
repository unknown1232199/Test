...
class EnUS
{
	...
	public static var translations:Map<String, String> = [
		...
		"If checked, this prevents the game from becoming \"slower\" and \"smoother\" when current FPS are lower than the framerate cap.",
		// Visuals Settings
		...
		"setting_vsync" => "VSync",
		"description_vsync" =>
		"If checked, enables VSync by fixing any screen tearing at the cost of limiting FPS to your monitor's refresh rate.\n(You need to restart the game for it to take effect)",
