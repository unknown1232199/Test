...
class IdID
{
	...
	public static var translations:Map<String, String> = [
		...
		"freeplay_tip" =>
		"Tekan SPACE untuk mendengarkan lagu / Tekan CTRL untuk membuka menu Gameplay Changers / Tekan RESET untuk mereset skor dan akurasi anda.",
		...
		"Jika diaktifkan, memungkinkan GPU digunakan untuk menyimpan tekstur dalam cache, sehingga mengurangi penggunaan RAM.\nJangan aktifkan opsi ini jika Anda memiliki kartu grafis yang buruk.",
		...
		"Jika dicentang, ini mencegah game menjadi \"lebih lambat\" dan \"lebih halus\" saat FPS saat ini lebih rendah dari batas framerate.",
		"setting_enable_preloader" => "Aktifkan Preloader",
		"description_enable_preloader" =>
		"Jika diaktifkan, akan memuat terlebih dahulu aset umum (gambar, suara, musik) saat startup untuk meningkatkan kinerja.\nDapat memperpanjang waktu pemuatan awal.",
		// Visuals Settings
		...
		"setting_vsync" => "VSync",
		"description_vsync" =>
		"Jika dicentang, mengaktifkan VSync dengan memperbaiki tearing layar dengan mengorbankan pembatasan FPS sesuai dengan kecepatan refresh monitor Anda.\n(Anda perlu menrestart game agar perubahan berlaku)",
		...
		"description_discord_rich_presence" =>
		"Batalkan centang ini untuk mencegah leaks yang tidak disengaja, hal ini akan menyembunyikan Aplikasi dari kotak \"Playing\" Anda di Discord.",
		"setting_combo_stacking" => "Penumpukan Kombo",
		"description_combo_stacking" =>
		"Jika tidak dicentangkan, Rating dan Kombo tidak akan ditumpuk, menghemat memori sistem dan membuatnya lebih mudah dibaca.",
		...
		"description_extra_controls" =>
		"Pilih berapa banyak kontrol ekstra yang Anda inginkan di layar.\nDapat digunakan untuk mekanik dengan LUA atau HSCRIPT.",
		"setting_mobile_controls_opacity" => "Opasitas Kontrol Ponsel",
		"description_mobile_controls_opacity" =>
		"Pilih tingkat opasitas untuk tombol-tombol pada perangkat ponsel (hati-hati jangan sampai mengaturnya ke 0 dan kehilangan jejak tombol-tombol Anda).",
		"setting_allow_phone_screensaver" => "Izinkan Layar Pengaman Ponsel",
		"description_allow_phone_screensaver" =>
		"Jika dicentang, ponsel akan masuk ke mode tidur setelah tidak aktif selama beberapa detik.\n(Waktu yang dibutuhkan tergantung pada pengaturan ponsel Anda)",
		"setting_wide_screen_mode" => "Mode Layar Lebar",
		"description_wide_screen_mode" =>
		"Jika dicentang, permainan akan diperluas untuk mengisi seluruh layar Anda. (PERINGATAN: Dapat menyebabkan tampilan yang buruk dan merusak beberapa mod yang mengubah ukuran permainan/kamera)",
		...
		"Jika dicentang, warna kontrol ponsel akan disetel ke warna note di pengaturan Anda.\n(berlaku hanya selama bermain game)",
		...
		"Shows chart information like scroll speed, BPM, health; also the steps, beats, etc.\nThe latter will be available if you are in Chart mode.",
